...
class TestTfLClient(unittest.TestCase):
    ...
    def test_get_arrivals_success(self, mock_get):
        ...
        mock_response.json.return_value = [
            {"id": "1", "lineName": "25", "destinationName": "Oxford Circus", "timeToStation": 300},
            {"id": "2", "lineName": "73", "destinationName": "Victoria", "timeToStation": 120},
            {"id": "3", "lineName": "25", "destinationName": "Oxford Circus", "timeToStation": 600},
        ]
